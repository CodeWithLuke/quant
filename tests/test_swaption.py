...
def test_swaption_vega_risk():
    ...
    par_swap = InterestRateSwap.par_swap(curve, 1000000, 1, CashFlowFrequency.SEMI_ANNUAL, start_time=2)

    swaption_obj = InterestRateSwaption.from_forward_swap(par_swap)

    report = swaption_obj.surface_vega_risk(curve, vol)
