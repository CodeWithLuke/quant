...
from utils.enum import InterpolationType


class InstrumentYieldCurve:

    def __init__(self, base_date: date, curve_points: List[CurvePoint], interpolation_type=InterpolationType.LINEAR,
        ...
        get_time = lambda curve_point: curve_point.base_date
    ...
    def _get_last_zero_rate(self):
        return self._curve_points[-1]

    def _add_curve_point(self, curve_point):
    ...
    def last_node(self):
        return CurvePoint(date.today(), 0.04)
